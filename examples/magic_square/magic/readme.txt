...
2. Installing the magic Package

A. Change to the directory that contains the file setup.py and the subdirectory magic. If 
...
3. Using the magic Package

The magic package is on your Python path. To import it into a Python script or session, 
execute:
